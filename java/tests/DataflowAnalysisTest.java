...
public class DataflowAnalysisTest {
    ...
    public void testGetUses() {
        ...
        assertTrue(usesWithoutTemps.contains(new SymbolAppearance("i", IntType.v(), 6, 12, 6, 13)));
        assertTrue(usesWithoutTemps.contains(new SymbolAppearance("j", IntType.v(), 7, 8, 7, 9)));
        assertTrue(usesWithoutTemps.contains(new SymbolAppearance("j", IntType.v(), 9, 23, 9, 24)));
        assertTrue(usesWithoutTemps.contains(new SymbolAppearance("i", IntType.v(), 9, 27, 9, 28)));
    ...
    public void testGetDefinitionsByName() {
        ...
        assertTrue(jDefs.contains(new SymbolAppearance("j", IntType.v(), 6, 8, 6, 9)));
    ...
    public void testGetDefinitionsByLine() {
        ...
        assertTrue(line5Defs.contains(new SymbolAppearance("i", IntType.v(), 5, 8, 5, 9)));

        Set<SymbolAppearance> line6Defs = linesToDefs.get(6);
        assertEquals(1, excludeTempAppearances(line6Defs).size());
        assertTrue(line6Defs.contains(new SymbolAppearance("j", IntType.v(), 6, 8, 6, 9)));
    ...
    public void testGetUsesByLine() {
        ...
        assertTrue(line6Uses.contains(new SymbolAppearance("i", IntType.v(), 6, 12, 6, 13)));

        Set<SymbolAppearance> line7Uses = linesToUses.get(7);
        assertEquals(1, excludeTempAppearances(line7Uses).size());
        assertTrue(line7Uses.contains(new SymbolAppearance("j", IntType.v(), 7, 8, 7, 9)));

        Set<SymbolAppearance> line9Uses = linesToUses.get(9);
        assertEquals(2, excludeTempAppearances(line9Uses).size());
        assertTrue(line9Uses.contains(new SymbolAppearance("j", IntType.v(), 9, 23, 9, 24)));
        assertTrue(line9Uses.contains(new SymbolAppearance("i", IntType.v(), 9, 27, 9, 28)));
    ...
    public void testGetUndefinedUsesByLines() {
        ...
        assertTrue(undefinedSymbols.contains(new SymbolAppearance("i", IntType.v(), 6, 12, 6, 13)));
        ...
        assertTrue(undefinedSymbols.contains(new SymbolAppearance("j", IntType.v(), 9, 23, 9, 24)));
        assertTrue(undefinedSymbols.contains(new SymbolAppearance("i", IntType.v(), 9, 27, 9, 28)));
    ...
    public void testGetLatestDefinitionBeforeUse() {
        ...
        SymbolAppearance definition = dataflowAnalysis.getLatestDefinitionBeforeUse(
            new SymbolAppearance("i", IntType.v(), 6, 12, 6, 13));
        assertEquals(new SymbolAppearance("i", IntType.v(), 5, 8, 5, 9), definition);
        ...
        definition = dataflowAnalysis.getLatestDefinitionBeforeUse(
            new SymbolAppearance("x", IntType.v(), 5, 4, 5, 5));
