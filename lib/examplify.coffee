...
module.exports = plugin =
  ...
  updateExampleCode: () ->
    ...
    for i in [0..sortedLineIndexes.length - 1]
  ...
  getActiveFilePath: () ->
    ...
    return plugin.getFilePath editor
  ...
  highlightDefinitions: (undefinedMarker, symbol) ->
    ...
    if (variableValues != undefined)
      ...
      value = plugin.getVariableValue symbol.symbolName, symbol.lineNumber
  ...
  highlightUndefined: () ->
    ...
    if dataflowAnalysis == undefined then return
    ...
    for i in [0..includedLines.length - 1]
    ...
    for use in undefinedUses
      ...
      if symbol.symbolName.startsWith "$" then return
      ...
      definitionButton.data 'symbol', symbol
      ...
      definitionButton.click (event) ->
        ...
        plugin.clearDefinitionMarkers [thisButtonMarker]
        plugin.highlightDefinitions thisButtonMarker, symbol
